...
class ConcaveDecoration extends Decoration {
  ...
  @override
  BoxPainter createBoxPainter([VoidCallback? onChanged]) => _ConcaveDecorationPainter(shape, depression, colors);
...
class _ConcaveDecorationPainter extends BoxPainter {
  ...
  void paint(
    ...
    for (final alignment in [Alignment.topLeft, Alignment.bottomRight]) {
      ...
      paint
        .shader = ui.Gradient.linear(shaderRect.topLeft, shaderRect.bottomRight, colors ?? [], stops);
