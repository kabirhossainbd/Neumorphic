...
class CalculatorAdd extends CalculatorVariable implements MathOperator {
  CalculatorAdd({required String value}) : super(value: '+');
}

class CalculatorMultiply extends CalculatorVariable implements MathOperator {
  CalculatorMultiply() : super(value: '*');
}

class CalculatorDivide extends CalculatorVariable implements MathOperator {
  CalculatorDivide() : super(value: '/');
}

class CalculatorDeduct extends CalculatorVariable implements MathOperator {
  CalculatorDeduct() : super(value: '-');
}

class CalculatorNumber extends CalculatorVariable {
  CalculatorNumber(String numberValue) : super(value: numberValue);
}
